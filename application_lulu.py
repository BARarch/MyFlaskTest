...
def index_lulu():
	...
	if request.method == 'GET':
	 ...
	 return render_template('layout_lulu.html', num=1, question='How many eyes do you have?', \
	 	ans1='1', ans2='2', ans3='3')

@app_lulu.route('/next_lulu',methods=['POST'])
def next_lulu(): #remember the functionname does not need to match the URL
	return redirect('/usefulfunction_lulu')

@app_lulu.route('/usefulfunction_lulu',methods=['GET', 'POST'])
def usefulfunction_lulu():
	return render_template('layout_lulu.html', num=1, question='Which fruit do you like best', \
		ans1='banana', ans2='mango', ans3='pineapple')
